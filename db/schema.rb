...
ActiveRecord::Schema.define(version: 2021_01_02_141923) do
  ...
  create_table "completes", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "completed_type", null: false
    t.bigint "completed_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["completed_type", "completed_id"], name: "index_completes_on_completed_type_and_completed_id"
